const Tooltip = ({
  ...
  return (
    <div
      className={`absolute px-2.5 py-1.25 bg-neutral-900 rounded-[11px] cursor-default hidden group-hover/tooltip:flex
    ...
    >
      ...
      <div
        ...
        `}
      />
      <span className="relative flex text-xs text-white whitespace-nowrap select-none">
        {label}
      </span>
    </div>
  );
