    ...
    <>
      ...
      >
        <div>
          ...
          <div className="flex flex-col gap-1 px-2">
            <button
              ...
              className={`flex gap-3 items-center p-2 w-full rounded-button transition-colors hover:text-text-primary
              ...
              chats.map((c) => (
                <div className="relative">
                  <button
                    ...
                    className={`flex gap-3 items-center p-2 h-9 w-full rounded-button hover:text-text-primary transition-colors group
                      ${
                        chatMenu === c.id ||
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`absolute -translate-y-1/2 right-0 top-1/2 flex p-2.25 bg-surface-hover rounded-button transition-opacity
                      ...
                      groups={[
                        <MenuGroup>
                          <button
                            ...
                            className="flex items-center gap-2 px-2.5 py-1.5 text-text-secondary rounded-button hover:bg-surface-hover hover:text-text-primary transition-colors"
                          >
                        ...
                        <MenuGroup>
                          <button
                            ...
                            className="flex items-center gap-2 px-2.5 py-1.5 text-red-400/70 rounded-button hover:bg-surface-hover hover:text-red-400 transition-colors"
                          >
        ...
        <div className="px-2 py-3">
          <button className="flex gap-3 items-center p-2 w-full rounded-button hover:bg-surface-hover text-text-secondary hover:text-text-primary transition-colors">
