      ...
      <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col gap-4 px-6 py-5 w-xl bg-light-bg rounded-[28px] border border-light-border">
        ...
        {type === "negative" && (
          <div className="flex flex-col gap-2">
            ...
            <button className="flex justify-between items-center px-4.5 py-2.25 bg-light-surface rounded-2xl border border-light-border">
              <span className="font-normal text-light-text-secondary select-none">
                Select...
              </span>
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="px-4.5 py-3 min-h-19 max-h-49 bg-light-surface placeholder:text-light-text-secondary rounded-3xl outline-none border border-light-border resize-none field-sizing-content hide-scrollbar"
