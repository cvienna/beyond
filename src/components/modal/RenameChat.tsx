  ...
  return (
    ...
    >
      <div
        ...
        className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col gap-4 px-6 py-5 w-xl bg-bg rounded-[28px] border border-border"
      >
        ...
        <div className="flex flex-col gap-2">
          <input
            ...
            className="px-3.5 py-2 bg-surface placeholder:text-text-secondary rounded-2xl outline-none border border-border resize-none field-sizing-content hide-scrollbar"
